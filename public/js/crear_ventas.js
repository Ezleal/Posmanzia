    ...
    if(metodo == "Efectivo"){
       ...
       $(this).parent().parent().parent().children('.transaccionEfectivo').html(
        ...
        '<div class="input-group-append">'+
           ...
           '<input type="numeric" class="form-control nuevoCambio" name="nuevoCambio" id="nuevoCambio" value="" min="0" step="any" autocomplete="nuevoCambio" autofocus placeholder="Cambio" readonly required></div>'
           )
