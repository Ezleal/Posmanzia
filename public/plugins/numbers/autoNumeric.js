! function (e, t) {
    ...
    return function (e) {
            ...
            g = function () {
                function e() {
                    ...
                    var r = e._setArgumentsValues(t, n, a),
                        ...
                        l = r.initialValue,
                        u = r.userOptions;
                    if (this.domElement = o, this.defaultRawValue = "", this._setSettings(u, !1), this._checkElement(), this.savedCancellableValue = null, this.historyTable = [], this.historyTableIndex = -1, this.onGoingRedo = !1, this.parentForm = this._getParentForm(), !this.runOnce && this.settings.formatOnPageLoad) this._formatDefaultValueOnPageLoad(l);
                    else {
                        var c = void 0;
                        if (d.default.isNull(l)) switch (this.settings.emptyInputBehavior) {
                    ...
                    this.runOnce = !0, (this.isInputElement || this.isContentEditable) && (this.settings.noEventListeners || this._createEventListeners(), this._setReadOnly()), this._saveInitialValues(l), this.sessionStorageAvailable = this.constructor._storageTest(), this.storageNamePrefix = "AUTO_", this._setPersistentStorageName(), this.isFocused = !1, this.isWheelEvent = !1, this.isDropEvent = !1, this.isEditing = !1, this.internalModification = !1, this.attributeToWatch = this._getAttributeToWatch(), this.getterSetter = Object.getOwnPropertyDescriptor(this.domElement.__proto__, this.attributeToWatch), this._addWatcher(), this.settings.createLocalList && this._createLocalList(), this.constructor._addToGlobalList(this), this.global = {
                        ...
                        has: function (t) {
                            return t instanceof e ? i.autoNumericLocalList.has(t.node()) : i.autoNumericLocalList.has(t)
                        },
                        addObject: function (t) {
                            var n = void 0,
                                a = void 0;
                            t instanceof e ? (n = t.node(), a = t) : (n = t, a = e.getAutoNumericElement(n)), i._hasLocalList() || i._createLocalList();
                            var s = a._getLocalList();
                            0 === s.size && (a._createLocalList(), s = a._getLocalList());
                            var r = void 0;
                            s instanceof Map ? r = d.default.mergeMaps(i._getLocalList(), s) : (i._addToLocalList(n, a), r = i._getLocalList()), r.forEach(function (e) {
                                e._setLocalList(r)
                            })
                        },
                        removeObject: function (t) {
                            var n = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                                a = void 0,
                                s = void 0;
                            t instanceof e ? (a = t.node(), s = t) : (a = t, s = e.getAutoNumericElement(a));
                        ...
                        decimalPlaces: function (e) {
                            return d.default.warning("Using `options.decimalPlaces()` instead of calling the specific `options.decimalPlacesRawValue()`, `options.decimalPlacesShownOnFocus()` and `options.decimalPlacesShownOnBlur()` methods will reset those options.\nPlease call the specific methods if you do not want to reset those.", i.settings.showWarnings), i.update({
                                decimalPlaces: e
                            }), i
                        },
                        ...
                        emptyInputBehavior: function (t) {
                            return null === i.rawValue && t !== e.options.emptyInputBehavior.null && (d.default.warning("You are trying to modify the `emptyInputBehavior` option to something different than `'null'` (" + t + "), but the element raw value is currently set to `null`. This would result in an invalid `rawValue`. In order to fix that, the element value has been changed to the empty string `''`.", i.settings.showWarnings), i.rawValue = ""), i.update({
                ...
                return u(e, [{
                    ...
                    value: function (e) {
                        this.initialValueHtmlAttribute = this.domElement.getAttribute("value"), d.default.isNull(this.initialValueHtmlAttribute) && (this.initialValueHtmlAttribute = ""), this.initialValue = e, d.default.isNull(this.initialValue) && (this.initialValue = "")
                    }
                }, {
                    ...
                    value: function () {
                        var e = this;
                        d.default.isNull(this.parentForm) || (this._onFormSubmitFunc = function () {
                            e._onFormSubmit()
                        }, this._hasParentFormCounter() ? this._incrementParentFormCounter() : (this._initializeFormCounterToOne(), this.parentForm.addEventListener("submit", this._onFormSubmitFunc, !1), this._storeFormHandlerFunction()))
                    }
                }, {
                    ...
                    value: function () {
                        if (!d.default.isNull(this.parentForm)) {
                            ...
                            1 === e ? (this.parentForm.removeEventListener("submit", this._getFormHandlerFunction(), !1), this._removeFormDataSetInfo()) : e > 1 ? this._decrementParentFormCounter() : d.default.throwError("The AutoNumeric object count on the form is incoherent.")
                        }
                    }
                }, {
                    ...
                    value: function () {
                        ...
                        this._getFormElement(e).dataset.anFormHandler = t, window.aNFormHandlerMap.set(t, this._onFormSubmitFunc)
                    }
                }, {
                    ...
                    value: function () {
                        var e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0],
                            t = void 0;
                        if (e ? (t = this.historyTableIndex > 0) && this.historyTableIndex-- : (t = this.historyTableIndex + 1 < this.historyTable.length) && this.historyTableIndex++, t) {
                            var i = this.historyTable[this.historyTableIndex];
                            this.set(i.value, null, !1), d.default.setElementSelection(this.domElement, i.start, i.end)
                        }
                    }
                }, {
                    ...
                    value: function () {
                        for (var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 1, t = [], i = 0; i < e; i++) t.push(this.historyTable.shift()), --this.historyTableIndex < 0 && (this.historyTableIndex = 0);
                    ...
                    value: function () {
                        ...
                        e < 0 && (e = 0);
                        return d.default.isUndefinedOrNullOrEmpty(this.historyTable[e]) ? "" : this.historyTable[e].value
                    }
                }, {
                    key: "_parseStyleRules",
                    value: function () {
                        var e = this;
                        d.default.isUndefinedOrNullOrEmpty(this.settings.styleRules) || "" === this.rawValue || (d.default.isUndefinedOrNullOrEmpty(this.settings.styleRules.positive) || (this.rawValue >= 0 ? this._addCSSClass(this.settings.styleRules.positive) : this._removeCSSClass(this.settings.styleRules.positive)), d.default.isUndefinedOrNullOrEmpty(this.settings.styleRules.negative) || (this.rawValue < 0 ? this._addCSSClass(this.settings.styleRules.negative) : this._removeCSSClass(this.settings.styleRules.negative)), d.default.isUndefinedOrNullOrEmpty(this.settings.styleRules.ranges) || 0 === this.settings.styleRules.ranges.length || this.settings.styleRules.ranges.forEach(function (t) {
                            e.rawValue >= t.min && e.rawValue < t.max ? e._addCSSClass(t.class) : e._removeCSSClass(t.class)
                        }), d.default.isUndefinedOrNullOrEmpty(this.settings.styleRules.userDefined) || 0 === this.settings.styleRules.userDefined.length || this.settings.styleRules.userDefined.forEach(function (t) {
                            if (d.default.isFunction(t.callback))
                                ...
                                d.default.isArray(i) ? t.classes.forEach(function (t, n) {
                                    d.default.isInArray(n, i) ? e._addCSSClass(t) : e._removeCSSClass(t)
                                }) : d.default.isInt(i) ? t.classes.forEach(function (t, n) {
                                    n === i ? e._addCSSClass(t) : e._removeCSSClass(t)
                                }) : d.default.isNull(i) ? t.classes.forEach(function (t) {
                                    e._removeCSSClass(t)
                                }) : d.default.throwError("The callback result is not an array nor a valid array index, " + (void 0 === i ? "undefined" : l(i)) + " given.")
                            ...
                            else d.default.warning("The given `styleRules` callback is not a function, " + ("undefined" == typeof callback ? "undefined" : l(callback)) + " given.", e.settings.showWarnings)
                        }))
                    }
                }, {
                    key: "_addCSSClass",
                    ...
                    key: "update",
                    value: function () {
                        for (var e = d.default.cloneObject(this.settings), t = this.rawValue, i = {}, n = arguments.length, a = Array(n), s = 0; s < n; s++) a[s] = arguments[s];
                        d.default.isUndefinedOrNullOrEmpty(a) || 0 === a.length ? i = null : a.length >= 1 && a.forEach(function (e) {
                            o(i, e)
                        });
                        try {
                            this._setSettings(i, !0), this.set(t)
                        } catch (t) {
                            return this._setSettings(e, !0), d.default.throwError("Unable to update the settings, those are invalid: [" + t + "]"), this
                        }
                        return this
                    }
                }, {
                    ...
                    value: function (t) {
                        ...
                        if (d.default.isUndefined(t)) return d.default.warning("You are trying to set an 'undefined' value ; an error could have occurred.", this.settings.showWarnings), this;
                        if (d.default.isNull(i) || this._setSettings(i, !0), null === t && this.settings.emptyInputBehavior !== e.options.emptyInputBehavior.null) return d.default.warning("You are trying to set the `null` value while the `emptyInputBehavior` option is set to " + this.settings.emptyInputBehavior + ". If you want to be able to set the `null` value, you need to change the 'emptyInputBehavior' option to `'null'`.", this.settings.showWarnings), this;
                        var a = void 0;
                        if (null === t) return this._setElementAndRawValue(null, null, n), this._saveValueToPersistentStorage(), this;
                        if (a = this.constructor._toNumericValue(t, this.settings), isNaN(Number(a))) return d.default.warning("The value you are trying to set results in `NaN`. The element value is set to the empty string instead.", this.settings.showWarnings), this.setValue("", n), this;
                        if ("" === a && this.settings.emptyInputBehavior === e.options.emptyInputBehavior.zero && (a = 0), "" !== a) {
                            var s = this.constructor._checkIfInRangeWithOverrideOption(a, this.settings),
                                o = r(s, 2),
                                l = o[0],
                                u = o[1];
                            if (l && u && this.settings.valuesToStrings && this._checkValuesToStrings(a)) return this._setElementAndRawValue(this.settings.valuesToStrings[a], a, n), this._saveValueToPersistentStorage(), this;
                            if (d.default.isZeroOrHasNoValue(a) && (a = "0"), l && u) {
                                var c = this.constructor._roundRawValue(a, this.settings);
                                return c = this._trimLeadingAndTrailingZeros(c.replace(this.settings.decimalCharacter, ".")), a = this._getRawValueToFormat(a), this.isFocused ? a = this.constructor._roundFormattedValueShownOnFocus(a, this.settings) : (this.settings.divisorWhenUnfocused && (a /= this.settings.divisorWhenUnfocused, a = a.toString()), a = this.constructor._roundFormattedValueShownOnBlur(a, this.settings)), a = this.constructor._modifyNegativeSignAndDecimalCharacterForFormattedValue(a, this.settings), a = this.constructor._addGroupSeparators(a, this.settings, this.isFocused, this.rawValue, c), !this.isFocused && this.settings.symbolWhenUnfocused && (a = "" + a + this.settings.symbolWhenUnfocused), (this.settings.decimalPlacesShownOnFocus || this.settings.divisorWhenUnfocused) && this._saveValueToPersistentStorage(), this._setElementAndRawValue(a, c, n), this
                            }
                            return l || this._triggerEvent(e.events.minRangeExceeded, this.domElement), u || this._triggerEvent(e.events.maxRangeExceeded, this.domElement), d.default.throwError("The value [" + a + "] being set falls outside of the minimumValue [" + this.settings.minimumValue + "] and maximumValue [" + this.settings.maximumValue + "] range set for this element"), this._removeValueFromPersistentStorage(), this.setValue("", n), this
                        }
                        var h = void 0;
                        return h = this.settings.emptyInputBehavior === e.options.emptyInputBehavior.always ? this.settings.currencySymbol : "", this._setElementAndRawValue(h, "", n), this
                    }
                }, {
                    key: "setUnformatted",
                    value: function (e) {
                        ...
                        var a = this.constructor._checkIfInRangeWithOverrideOption(n, this.settings),
                            ...
                            o = s[0],
                            l = s[1];
                        return o && l ? this.setValue(e) : d.default.throwError("The value is out of the range limits [" + this.settings.minimumValue + ", " + this.settings.maximumValue + "]."), this
                    }
                }, {
                    key: "setValue",
                    value: function (e) {
                    ...
                    value: function (t) {
                        ...
                        if (this.rawValue !== t) {
                            var n = this.rawValue;
                            this.rawValue = t, !d.default.isNull(this.settings.rawValueDivisor) && 0 !== this.settings.rawValueDivisor && "" !== t && null !== t && this._isUserManuallyEditingTheValue() && (this.rawValue /= this.settings.rawValueDivisor), this._triggerEvent(e.events.rawValueModified, this.domElement, {
                                oldRawValue: n,
                                newRawValue: this.rawValue,
                    ...
                    value: function (t) {
                        ...
                        return t !== n && (this.internalModification = !0, d.default.setElementValue(this.domElement, t), this.internalModification = !1, i && this._triggerEvent(e.events.formatted, this.domElement, {
                            oldValue: n,
                            newValue: t,
                    ...
                    value: function () {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
                            t = void 0;
                        return t = d.default.isNull(this.rawValue) ? null : d.default.trimPaddedZerosFromDecimalPlaces(this.rawValue), this._executeCallback(t, e), t
                    }
                }, {
                    key: "getFormatted",
                    value: function () {
                    ...
                    value: function () {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
                            t = void 0;
                        return t = null === this.rawValue ? null : this.constructor._toLocale(this.getNumericString(), "number", this.settings), this._executeCallback(t, e), t
                    }
                }, {
                    key: "getLocalized",
                    value: function () {
                        ...
                        d.default.isFunction(t) && d.default.isNull(i) && (i = t, t = null);
                        var n = void 0;
                        "" !== (n = d.default.isEmptyString(this.rawValue) ? "" : "" + Number(this.rawValue)) && 0 === Number(n) && this.settings.leadingZero !== e.options.leadingZero.keep && (n = "0");
                        var a = void 0;
                    ...
                    value: function () {
                        var e = !(arguments.length > 0 && void 0 !== arguments[0]) || arguments[0];
                        return e ? this.initialValue === this.getNumericString() : this.initialValueHtmlAttribute === this.getFormatted()
                    }
                }, {
                    key: "select",
                    value: function () {
                    ...
                    value: function () {
                        ...
                        return d.default.setElementSelection(this.domElement, o, l), this
                    }
                }, {
                    key: "selectInteger",
                    value: function () {
                        ...
                        return -1 === a && (a = this.settings.currencySymbolPlacement === e.options.currencySymbolPlacement.suffix ? n.length - this.settings.currencySymbol.length : n.length, i || this.settings.negativePositiveSignPlacement !== e.options.negativePositiveSignPlacement.suffix && this.settings.currencySymbolPlacement !== e.options.currencySymbolPlacement.suffix || (a -= 1), a -= this.settings.suffixText.length), d.default.setElementSelection(this.domElement, t, a), this
                    }
                }, {
                    key: "selectDecimal",
                    value: function () {
                        var e = d.default.getElementValue(this.domElement).indexOf(this.settings.decimalCharacter),
                            t = void 0;
                        if (-1 === e) e = 0, t = 0;
                        else {
                            e += 1;
                        ...
                        return d.default.setElementSelection(this.domElement, e, t), this
                    }
                }, {
                    key: "node",
                    value: function () {
                    ...
                    value: function () {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
                            t = void 0;
                        return t = d.default.isNull(e) ? this.domElement : e.node(), this._removeFromLocalList(t), this
                    }
                }, {
                    key: "attach",
                    value: function (e) {
                    ...
                    value: function (t, i) {
                        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null,
                            a = void 0;
                        a = d.default.isNull(n) ? this.settings : this._cloneAndMergeSettings(n);
                        var s = void 0;
                        if (d.default.isElement(i)) {
                            var r = d.default.getElementValue(i);
                            return s = t ? e.format(r, a) : e.unformat(r, a), d.default.setElementValue(i, s), null
                        }
                    ...
                    key: "form",
                    value: function () {
                        if (arguments.length > 0 && void 0 !== arguments[0] && arguments[0] || d.default.isUndefinedOrNullOrEmpty(this.parentForm)) {
                    ...
                    value: function (e) {
                        var t = this;
                        return [].concat(a(e.querySelectorAll("input"))).filter(function (e) {
                    ...
                    value: function () {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
                            t = void 0;
                        return t = d.default.isNull(e) ? this.settings.outputFormat : e, this.constructor._serializeLocalized(this.form(), this.settings.serializeSpaces, t)
                    }
                }, {
                    ...
                    value: function () {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
                            t = void 0;
                        return t = d.default.isNull(e) ? this.settings.outputFormat : e, this.constructor._serializeLocalizedArray(this.form(), this.settings.serializeSpaces, t)
                    }
                }, {
                    ...
                    value: function () {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null;
                        return d.default.isNull(e) ? (this.formUnformat(), this.form().submit(), this.formReformat()) : d.default.isFunction(e) ? e(this.formNumericString()) : d.default.throwError("The given callback is not a function."), this
                    }
                }, {
                    ...
                    value: function () {
                        ...
                        return d.default.isNull(t) ? (this.formUnformatLocalized(), this.form().submit(), this.formReformat()) : d.default.isFunction(t) ? t(this.formLocalized(e)) : d.default.throwError("The given callback is not a function."), this
                    }
                }, {
                    ...
                    value: function (e) {
                        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
                        d.default.isNull(t) && (t = this), d.default.isUndefined(this.autoNumericLocalList) ? d.default.throwError("The local list provided does not exists when trying to add an element. [" + this.autoNumericLocalList + "] given.") : this.autoNumericLocalList.set(e, t)
                    }
                }, {
                    key: "_removeFromLocalList",
                    value: function (e) {
                        d.default.isUndefined(this.autoNumericLocalList) ? this.settings.createLocalList && d.default.throwError("The local list provided does not exists when trying to remove an element. [" + this.autoNumericLocalList + "] given.") : this.autoNumericLocalList.delete(e)
                    }
                }, {
                    key: "_mergeSettings",
                    value: function () {
                    ...
                    key: "_setBrackets",
                    value: function () {
                        if (d.default.isNull(this.settings.negativeBracketsTypeOnBlur)) this.settings.firstBracket = "", this.settings.lastBracket = "";
                        else {
                    ...
                    value: function (t) {
                        d.default.isNull(this.settings.caretPositionOnFocus) && this.settings.selectOnFocus === e.options.selectOnFocus.doNotSelect && d.default.throwError("`_initialCaretPosition()` should never be called when the `caretPositionOnFocus` option is `null`.");
                    ...
                    value: function (t) {
                        ...
                        return d.default.contains(t, ".") && (t = t.replace(/(\.[0-9]*?)0+$/, "$1")), t = t.replace(/\.$/, "")
                    }
                }, {
                    key: "_setPersistentStorageName",
                    value: function () {
                        this.settings.saveValueToSessionStorage && ("" === this.domElement.name || d.default.isUndefined(this.domElement.name) ? this.rawValueStorageName = "" + this.storageNamePrefix + this.domElement.id : this.rawValueStorageName = "" + this.storageNamePrefix + decodeURIComponent(this.domElement.name))
                    }
                }, {
                    ...
                    value: function () {
                        if (this.settings.saveValueToSessionStorage) {
                            return this.sessionStorageAvailable ? sessionStorage.getItem(this.rawValueStorageName) : this._readCookie(this.rawValueStorageName)
                        }
                        return d.default.warning("`_getValueFromPersistentStorage()` is called but `settings.saveValueToSessionStorage` is false. There must be an error that needs fixing.", this.settings.showWarnings), null
                    }
                }, {
                    ...
                    value: function (t) {
                        if (this.isEditing = !1, this.settings.unformatOnHover && "mouseenter" === t.type && t.altKey) return void this.constructor._unformatAltHovered(this);
                        if ("focus" === t.type && (this.isFocused = !0), "focus" === t.type && this.settings.unformatOnHover && this.hoveredWithAlt && this.constructor._reformatAltHovered(this), "focus" === t.type || "mouseenter" === t.type && !this.isFocused) {
                            var i = null;
                            this.settings.emptyInputBehavior === e.options.emptyInputBehavior.focus && this.rawValue < 0 && null !== this.settings.negativeBracketsTypeOnBlur && this.settings.isNegativeSignAllowed && (i = this.constructor._removeBrackets(d.default.getElementValue(this.domElement), this.settings));
                            ...
                            d.default.isNull(i) ? this.valueOnFocus = "" : this.valueOnFocus = i, this.lastVal = this.valueOnFocus;
                            ...
                            l && (i = o), d.default.isNull(i) || this._setElementValue(i), l && o === this.settings.currencySymbol && this.settings.currencySymbolPlacement === e.options.currencySymbolPlacement.suffix && d.default.setElementSelection(t.target, 0)
                        }
                    }
                }, {
                    key: "_onFocus",
                    ...
                    key: "_onFocusIn",
                    value: function (e) {
                        this.settings.selectOnFocus ? this.select() : d.default.isNull(this.settings.caretPositionOnFocus) || d.default.setElementSelection(e.target, this._initialCaretPosition(d.default.getElementValue(this.domElement)))
                    }
                }, {
                    key: "_onKeydown",
                    value: function (t) {
                        if (this.formatted = !1, this.isEditing = !0, !this.isFocused && this.settings.unformatOnHover && t.altKey && this.domElement === d.default.getHoveredElement()) return void this.constructor._unformatAltHovered(this);
                        if (this._updateEventKeyInfo(t), this.initialValueOnKeydown = d.default.getElementValue(t.target), this.initialRawValueOnKeydown = this.rawValue, this.domElement.readOnly) return void(this.processed = !0);
                        this.eventKey === m.default.keyName.Esc && (t.preventDefault(), this.settings.isCancellable && this.rawValue !== this.savedCancellableValue && (this.set(this.savedCancellableValue), this._triggerEvent(e.events.native.input, t.target)), this.select());
                        var i = d.default.getElementValue(t.target);
                        if (this.eventKey === m.default.keyName.Enter && this.valueOnFocus !== i && (this._triggerEvent(e.events.native.change, t.target), this.valueOnFocus = i, this.settings.isCancellable && this._saveCancellableValue()), this._updateInternalProperties(t), this._processNonPrintableKeysAndShortcuts(t)) return void(this.processed = !0);
                        this.eventKey !== m.default.keyName.Backspace && this.eventKey !== m.default.keyName.Delete || (this._processCharacterDeletion(), this.processed = !0, this._formatValue(t), i = d.default.getElementValue(t.target), i !== this.lastVal && this.throwInput && (this._triggerEvent(e.events.native.input, t.target), t.preventDefault()), this.lastVal = i, this.throwInput = !0)
                    }
                }, {
                    key: "_onKeypress",
                    value: function (t) {
                        if (this.eventKey !== m.default.keyName.Insert) {
                            ...
                            if (this._updateInternalProperties(t), !this._processNonPrintableKeysAndShortcuts(t)) {
                                ...
                                if (this._processCharacterInsertion()) {
                                    ...
                                    if (n !== this.lastVal && this.throwInput) this._triggerEvent(e.events.native.input, t.target), t.preventDefault();
                                    else {
                                        if ((this.eventKey === this.settings.decimalCharacter || this.eventKey === this.settings.decimalCharacterAlternative) && d.default.getElementSelection(t.target).start === d.default.getElementSelection(t.target).end && d.default.getElementSelection(t.target).start === n.indexOf(this.settings.decimalCharacter)) {
                                            var a = d.default.getElementSelection(t.target).start + 1;
                                            d.default.setElementSelection(t.target, a)
                                        }
                                        t.preventDefault()
                                    }
                                    return this.lastVal = d.default.getElementValue(t.target), void(this.throwInput = !0)
                                }
                                t.preventDefault()
                            }
                        }
                    ...
                    key: "_onKeyup",
                    value: function (t) {
                        if (this.isEditing = !1, this.settings.isCancellable && this.eventKey === m.default.keyName.Esc) return void t.preventDefault();
                        if (this.eventKey === m.default.keyName.Z || this.eventKey === m.default.keyName.z) {
                        ...
                        if (this.onGoingRedo && (t.ctrlKey || t.shiftKey) && (this.onGoingRedo = !1), (t.ctrlKey || t.metaKey) && this.eventKey === m.default.keyName.x) {
                        ...
                        if (this.eventKey === m.default.keyName.Alt && this.hoveredWithAlt) return void this.constructor._reformatAltHovered(this);
                        ...
                        if (!a && "" !== s && (s === this.settings.currencySymbol ? this.settings.currencySymbolPlacement === e.options.currencySymbolPlacement.suffix ? d.default.setElementSelection(t.target, 0) : d.default.setElementSelection(t.target, this.settings.currencySymbol.length) : this.eventKey === m.default.keyName.Tab && d.default.setElementSelection(t.target, 0, s.length), (s === this.settings.suffixText || "" === this.rawValue && "" !== this.settings.currencySymbol && "" !== this.settings.suffixText) && d.default.setElementSelection(t.target, 0), null !== this.settings.decimalPlacesShownOnFocus && this._saveValueToPersistentStorage(), this.formatted || this._formatValue(t), this._saveRawValueForAndroid(), s !== this.initialValueOnKeydown && this._triggerEvent(e.events.formatted, t.target, {
                    ...
                    value: function (t) {
                        ...
                        if ("mouseleave" === t.type && !this.isFocused || "blur" === t.type) {
                            ...
                            var i = this._getRawValueToFormat(this.rawValue),
                                ...
                                l = s[1],
                                u = !1;
                            if ("" === i || n || (o || this._triggerEvent(e.events.minRangeExceeded, this.domElement), l || this._triggerEvent(e.events.maxRangeExceeded, this.domElement), this.settings.valuesToStrings && this._checkValuesToStrings(i) && (this._setElementValue(this.settings.valuesToStrings[i]), u = !0)), !u) {
                                var c = void 0;
                                c = n || "" === i ? i : String(i), "" === i || n ? "" === i && this.settings.emptyInputBehavior === e.options.emptyInputBehavior.zero && (this._setRawValue("0"), c = this.constructor._roundValue("0", this.settings, 0)) : o && l && !this.constructor._isElementValueEmptyOrOnlyTheNegativeSign(i, this.settings) ? (c = this._modifyNegativeSignAndDecimalCharacterForRawValue(c), this.settings.divisorWhenUnfocused && !d.default.isNull(c) && (c /= this.settings.divisorWhenUnfocused, c = c.toString()), c = this.constructor._roundFormattedValueShownOnBlur(c, this.settings), c = this.constructor._modifyNegativeSignAndDecimalCharacterForFormattedValue(c, this.settings)) : (o || this._triggerEvent(e.events.minRangeExceeded, this.domElement), l || this._triggerEvent(e.events.maxRangeExceeded, this.domElement));
                                var h = this.constructor._orderValueCurrencySymbolAndSuffixText(c, this.settings, !1);
                    ...
                    value: function (t) {
                        if (t.preventDefault(), !(this.settings.readOnly || this.domElement.readOnly || this.domElement.disabled)) {
                            var i = void 0;
                            window.clipboardData && window.clipboardData.getData ? i = window.clipboardData.getData("Text") : t.clipboardData && t.clipboardData.getData ? i = t.clipboardData.getData("text/plain") : d.default.throwError("Unable to retrieve the pasted value. Please use a modern browser (ie. Firefox or Chromium).");
                            var n = void 0;
                            ...
                            if (o === a.length) {
                                ...
                                return "." === u || "" === u || "." !== u && !d.default.isNumber(u) ? (this.formatted = !0, void(this.settings.onInvalidPaste === e.options.onInvalidPaste.error && d.default.throwError("The pasted value '" + i + "' is not a valid paste content."))) : (this.set(u), void(this.formatted = !0))
                            }
                            var c = d.default.isNegativeStrict(i, this.settings.negativeSignCharacter);
                            c && (i = i.slice(1, i.length));
                            var h = this._preparePastedText(i),
                                m = void 0;
                            if ("." !== (m = "." === h ? "." : d.default.arabicToLatinNumbers(h, !1, !1, !1)) && (!d.default.isNumber(m) || "" === m)) return this.formatted = !0, void(this.settings.onInvalidPaste === e.options.onInvalidPaste.error && d.default.throwError("The pasted value '" + i + "' is not a valid paste content."));
                            var g = void 0,
                            ...
                            switch (this.settings.onInvalidPaste) {
                                ...
                                case e.options.onInvalidPaste.replace:
                                    ...
                                    p = s !== r ? this._preparePastedText(P + w) : this._preparePastedText(a), f && (p = d.default.setRawNegativeSign(p)), g = d.default.convertCharacterCountToIndexPosition(d.default.countNumberCharactersOnTheCaretLeftSide(a, s, this.settings.decimalCharacter)), v && g++, S = p.slice(0, g), b = p.slice(g, p.length), "." === m && (d.default.contains(S, ".") && (y = !0, S = S.replace(".", "")), b = b.replace(".", ""));
                                    for (var O = d.default.parseStr(this.settings.minimumValue), N = d.default.parseStr(this.settings.maximumValue), E = p, k = 0, _ = S; k < m.length && (_ += m[k], p = _ + b, this.constructor._checkIfInRange(p, O, N));) E = p, k++;
                                    if (g += k, this.settings.onInvalidPaste === e.options.onInvalidPaste.truncate) {
                                        p = E, y && g--;
                                        break
                                    }
                                    for (var C = g, F = E.length; k < m.length && C < F;)
                                        if ("." !== E[C]) {
                                            if (p = d.default.replaceCharAt(E, C, m[k]), !this.constructor._checkIfInRange(p, O, N)) break;
                                            E = p, k++, C++
                                        } else C++;
                                    g = C, y && g--, p = E;
                                    break;
                                ...
                                default:
                                    ...
                                    if (p = s !== r ? this._preparePastedText(V + T) : this._preparePastedText(a), f && (p = d.default.setRawNegativeSign(p)), g = d.default.convertCharacterCountToIndexPosition(d.default.countNumberCharactersOnTheCaretLeftSide(a, s, this.settings.decimalCharacter)), v && g++, S = p.slice(0, g), b = p.slice(g, p.length), "." === m && (d.default.contains(S, ".") && (y = !0, S = S.replace(".", "")), b = b.replace(".", "")), p = "" + S + m + b, s === r) {
                                        g = d.default.convertCharacterCountToIndexPosition(d.default.countNumberCharactersOnTheCaretLeftSide(a, s, this.settings.decimalCharacter)) + m.length
                                    } else if ("" === b) g = d.default.convertCharacterCountToIndexPosition(d.default.countNumberCharactersOnTheCaretLeftSide(a, s, this.settings.decimalCharacter)) + m.length;
                                    else {
                                        var x = d.default.convertCharacterCountToIndexPosition(d.default.countNumberCharactersOnTheCaretLeftSide(a, r, this.settings.decimalCharacter)),
                                            A = d.default.getElementValue(n).slice(s, r);
                                        g = x - o + d.default.countCharInText(this.settings.digitGroupSeparator, A) + m.length
                                    }
                                    v && g++, y && g--
                            }
                            if (!d.default.isNumber(p) || "" === p) return void(this.settings.onInvalidPaste === e.options.onInvalidPaste.error && d.default.throwError("The pasted value '" + i + "' would result into an invalid content '" + p + "'."));
                            var L = !1,
                                D = !1;
                            try {
                                this.set(p), L = !0
                                ...
                                switch (this.settings.onInvalidPaste) {
                                    case e.options.onInvalidPaste.clamp:
                                        ...
                                        try {
                                            ...
                                            d.default.throwError("Fatal error: Unable to set the clamped value '" + B + "'.")
                                        }
                                        D = !0, L = !0, p = B;
                                        break;
                                    case e.options.onInvalidPaste.error:
                            ...
                            if (L) switch (this.settings.onInvalidPaste) {
                                case e.options.onInvalidPaste.clamp:
                                    if (D) {
                                        this.settings.currencySymbolPlacement === e.options.currencySymbolPlacement.suffix ? d.default.setElementSelection(n, I.length - this.settings.currencySymbol.length) : d.default.setElementSelection(n, I.length);
                                        break
                                    }
                                    case e.options.onInvalidPaste.error:
                                    case e.options.onInvalidPaste.ignore:
                            ...
                            L && a !== I && this._triggerEvent(e.events.native.input, n)
                        }
                    }
                }, {
                    key: "_onBlur",
                    value: function (t) {
                        this.isFocused = !1, this.isEditing = !1, d.default.getElementValue(t.target) !== this.valueOnFocus && this._triggerEvent(e.events.native.change, t.target)
                    }
                }, {
                    key: "_onWheel",
                    value: function (t) {
                        this.settings.readOnly || this.domElement.readOnly || this.domElement.disabled || this.settings.modifyValueOnWheel && (this.settings.wheelOn === e.options.wheelOn.focus ? this.isFocused ? t.shiftKey || this.wheelAction(t) : t.shiftKey && this.wheelAction(t) : this.settings.wheelOn === e.options.wheelOn.hover ? t.shiftKey ? (t.preventDefault(), window.scrollBy(0, d.default.isNegativeStrict(String(t.deltaY)) ? -50 : 50)) : this.wheelAction(t) : d.default.throwError("Unknown `wheelOn` option."))
                    }
                }, {
                    key: "wheelAction",
                    value: function (t) {
                        ...
                        var i = t.target.selectionStart || 0,
                            ...
                            a = this.rawValue,
                            s = void 0;
                        if (d.default.isUndefinedOrNullOrEmpty(a) ? this.settings.minimumValue > 0 || this.settings.maximumValue < 0 ? d.default.isWheelUpEvent(t) ? s = this.settings.minimumValue : d.default.isWheelDownEvent(t) ? s = this.settings.maximumValue : d.default.throwError("The event is not a 'wheel' event.") : s = 0 : s = a, s = +s, d.default.isNumber(this.settings.wheelStep)) {
                            var r = +this.settings.wheelStep;
                            d.default.isWheelUpEvent(t) ? s += r : d.default.isWheelDownEvent(t) && (s -= r)
                        } else d.default.isWheelUpEvent(t) ? s = d.default.addAndRoundToNearestAuto(s, this.settings.decimalPlacesRawValue) : d.default.isWheelDownEvent(t) && (s = d.default.subtractAndRoundToNearestAuto(s, this.settings.decimalPlacesRawValue));
                        s = d.default.clampToRangeLimits(s, this.settings), s !== +a && (this.set(s), this._triggerEvent(e.events.native.input, t.target)), t.preventDefault(), this._setSelection(i, n), this.isWheelEvent = !1
                    }
                }, {
                    key: "_onDrop",
                    value: function (e) {
                    ...
                    value: function () {
                        return d.default.isElement(this.domElement) || d.default.throwError("The DOM element is not valid, " + this.domElement + " given."), d.default.isInArray(this.domElement.tagName.toLowerCase(), this.allowedTagList)
                    }
                }, {
                    key: "_isInputElement",
                    value: function () {
                    ...
                    value: function () {
                        ...
                        this._isElementTagSupported() || d.default.throwError("The <" + e + "> tag is not supported by autoNumeric"), this._isInputElement() ? (this._isInputTypeSupported() || d.default.throwError('The input type "' + this.domElement.type + '" is not supported by autoNumeric'), this.isInputElement = !0) : (this.isInputElement = !1, this.isContentEditable = this.domElement.hasAttribute("contenteditable") && "true" === this.domElement.getAttribute("contenteditable"))
                    }
                }, {
                    ...
                    value: function () {
                        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : null,
                            i = !0,
                            n = void 0;
                        if (d.default.isNull(t) ? (n = d.default.getElementValue(this.domElement).trim(), this.domElement.setAttribute("value", n)) : n = t, this.isInputElement || this.isContentEditable) {
                            ...
                            if (this.domElement.hasAttribute("value") && "" !== this.domElement.getAttribute("value")) {
                                if (null !== this.settings.defaultValueOverride && this.settings.defaultValueOverride.toString() !== n || null === this.settings.defaultValueOverride && "" !== n && n !== this.domElement.getAttribute("value") || "" !== n && "hidden" === this.domElement.getAttribute("type") && !d.default.isNumber(a)) {
                                    if (this.settings.saveValueToSessionStorage && (null !== this.settings.decimalPlacesShownOnFocus || this.settings.divisorWhenUnfocused) && this._setRawValue(this._getValueFromPersistentStorage()), !this.settings.saveValueToSessionStorage) {
                                        var s = this.constructor._removeBrackets(n, this.settings);
                            ...
                            } else isNaN(Number(a)) || 1 / 0 === a ? d.default.throwError("The value [" + n + "] used in the input is not a valid value autoNumeric can work with.") : (this.set(a), i = !1);
                        ...
                        } else null !== this.settings.defaultValueOverride && this.settings.defaultValueOverride !== n || this.set(n)
                    }
                }, {
                    ...
                    value: function () {
                        var e = this.settings.maximumValue.toString().split("."),
                            ...
                            a = r(n, 1),
                            s = a[0];
                        i = i.replace(this.settings.negativeSignCharacter, ""), s = s.replace(this.settings.negativeSignCharacter, ""), this.settings.mIntPos = Math.max(i.length, 1), this.settings.mIntNeg = Math.max(s.length, 1)
                    }
                }, {
                    ...
                    value: function (e) {
                        var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1];
                        if (!t && d.default.isNull(e) || this.constructor._convertOldOptionsToNewOnes(e), t) {
                            "decimalPlacesRawValue" in e && (this.settings.originalDecimalPlacesRawValue = e.decimalPlacesRawValue);
                            "decimalPlaces" in e && (this.settings.originalDecimalPlaces = e.decimalPlaces), this.constructor._calculateDecimalPlacesOnUpdate(e, this.settings), this._mergeSettings(e)
                        ...
                        }), this.caretFix = !1, this.throwInput = !0, this.allowedTagList = m.default.allowedTagList, this.runOnce = !1, this.hoveredWithAlt = !1;
                        this._transformOptionsValuesToDefaultTypes(), this._runCallbacksFoundInTheSettingsObject(), this.constructor._correctNegativePositiveSignPlacementOption(this.settings), this.constructor._correctCaretPositionOnFocusAndSelectOnFocusOptions(this.settings), this.constructor._setNegativePositiveSignPermissions(this.settings), t || (d.default.isNull(e) || !e.decimalPlaces ? this.settings.originalDecimalPlaces = null : this.settings.originalDecimalPlaces = e.decimalPlaces, this.settings.originalDecimalPlacesRawValue = this.settings.decimalPlacesRawValue, this.constructor._calculateDecimalPlacesOnInit(this.settings)), this._calculateVMinAndVMaxIntegerSizes(), this._setTrailingNegativeSignInfo(), this.regex = {}, this.constructor._cachesUsualRegularExpressions(this.settings, this.regex), this._setBrackets(), this._calculateValuesToStringsKeys(), d.default.isEmptyObj(this.settings) && d.default.throwError("Unable to set the settings, those are invalid ; an empty object was given."), this.constructor.validate(this.settings, !1, e), this._keepAnOriginalSettingsCopy()
                    }
                }, {
                    ...
                    key: "_setSelection",
                    value: function (e, t) {
                        e = Math.max(e, 0), t = Math.min(t, d.default.getElementValue(this.domElement).length), this.selection = {
                            start: e,
                            end: t,
                            length: t - e
                    ...
                    value: function (t, i) {
                        var n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
                            ...
                            m = d[1];
                        if (h && m) {
                            var g = e._truncateDecimalPlaces(u, this.settings, n, this.settings.decimalPlacesRawValue),
                                f = g.replace(this.settings.decimalCharacter, ".");
                            if ("" === f || f === this.settings.negativeSignCharacter) {
                                var v = void 0;
                                ...
                                this._setRawValue(v)
                            } else this._setRawValue(this._trimLeadingAndTrailingZeros(f));
                            var p = e._truncateDecimalPlaces(u, this.settings, n, this.settings.decimalPlacesShownOnFocus),
                                y = o.length;
                            return y > p.length && (y = p.length), 1 === y && "0" === o && this.settings.leadingZero === e.options.leadingZero.deny && (y = "" === l || "0" === o && "" !== l ? 1 : 0), this._setElementValue(p, !1), this._setCaretPosition(y), !0
                        }
                        return h ? m || this._triggerEvent(e.events.maxRangeExceeded, this.domElement) : this._triggerEvent(e.events.minRangeExceeded, this.domElement), !1
                    }
                }, {
                    ...
                    value: function () {
                        var e = this._getSignPosition(),
                            ...
                            n = t[1],
                            a = this.selection;
                        a.start < n && a.end > i && ((a.start < i || a.end > n) && d.default.getElementValue(this.domElement).substring(Math.max(a.start, i), Math.min(a.end, n)).match(/^\s*$/) ? a.start < i ? this._setSelection(a.start, i) : this._setSelection(n, a.end) : this._setSelection(Math.min(a.start, i), Math.max(a.end, n)))
                    }
                }, {
                    key: "_checkPaste",
                    value: function () {
                        if (!this.formatted && !d.default.isUndefined(this.valuePartsBeforePaste)) {
                            var t = this.valuePartsBeforePaste,
                                ...
                                s = n[1];
                            delete this.valuePartsBeforePaste;
                            var o = a.substr(0, t[0].length) + e._stripAllNonNumberCharactersExceptCustomDecimalChar(a.substr(t[0].length), this.settings, !0, this.isFocused);
                    ...
                    value: function (e) {
                        if ((e.ctrlKey || e.metaKey) && "keyup" === e.type && !d.default.isUndefined(this.valuePartsBeforePaste) || e.shiftKey && this.eventKey === m.default.keyName.Insert) return this._checkPaste(), !1;
                        if (this.constructor._shouldSkipEventKey(this.eventKey)) return !0;
                        if ((e.ctrlKey || e.metaKey) && this.eventKey === m.default.keyName.a) return this.settings.selectNumberOnly && (e.preventDefault(), this.selectNumber()), !0;
                        if ((e.ctrlKey || e.metaKey) && (this.eventKey === m.default.keyName.c || this.eventKey === m.default.keyName.v || this.eventKey === m.default.keyName.x)) return "keydown" === e.type && this._expandSelectionOnSign(), this.eventKey !== m.default.keyName.v && this.eventKey !== m.default.keyName.Insert || ("keydown" === e.type || "keypress" === e.type ? d.default.isUndefined(this.valuePartsBeforePaste) && (this.valuePartsBeforePaste = this._getLeftAndRightPartAroundTheSelection()) : this._checkPaste()), "keydown" === e.type || "keypress" === e.type || this.eventKey === m.default.keyName.c;
                        if (e.ctrlKey || e.metaKey) return this.eventKey !== m.default.keyName.Z && this.eventKey !== m.default.keyName.z;
                        if (this.eventKey === m.default.keyName.LeftArrow || this.eventKey === m.default.keyName.RightArrow) {
                            if ("keydown" === e.type && !e.shiftKey) {
                                var t = d.default.getElementValue(this.domElement);
                                this.eventKey !== m.default.keyName.LeftArrow || t.charAt(this.selection.start - 2) !== this.settings.digitGroupSeparator && t.charAt(this.selection.start - 2) !== this.settings.decimalCharacter ? this.eventKey !== m.default.keyName.RightArrow || t.charAt(this.selection.start + 1) !== this.settings.digitGroupSeparator && t.charAt(this.selection.start + 1) !== this.settings.decimalCharacter || this._setCaretPosition(this.selection.start + 1) : this._setCaretPosition(this.selection.start - 1)
                            }
                            return !0
                        }
                    ...
                    value: function (t) {
                        var i = r(t, 2),
                            ...
                            o = d.default.isNegative(s, this.settings.negativeSignCharacter);
                    ...
                    value: function () {
                        ...
                        if (this.selection.length) {
                            ...
                            var a = this._getUnformattedLeftAndRightPartAroundTheSelection(),
                                s = r(a, 2);
                            if (e = s[0], t = s[1], "" === e && "" === t && (this.throwInput = !1), this.isTrailingNegative && d.default.isNegative(d.default.getElementValue(this.domElement), this.settings.negativeSignCharacter)) {
                                var o = this._processCharacterDeletionIfTrailingNegativeSign([e, t]),
                                    l = r(o, 2);
                                e = l[0], t = l[1]
                            } else this.eventKey === m.default.keyName.Backspace ? e = e.substring(0, e.length - 1) : t = t.substring(1, t.length)
                        }
                    ...
                    value: function () {
                        var e = this._getUnformattedLeftAndRightPartAroundTheSelection(),
                            ...
                            i = t[0],
                            n = t[1];
                        if (this.eventKey !== m.default.keyName.AndroidDefault && (this.throwInput = !0), this.eventKey === this.settings.decimalCharacter || this.settings.decimalCharacterAlternative && this.eventKey === this.settings.decimalCharacterAlternative) return !this._isDecimalCharacterInsertionAllowed() || !this.settings.decimalCharacter || (!(!this.settings.negativeSignCharacter || !d.default.contains(n, this.settings.negativeSignCharacter)) || (!!d.default.contains(i, this.settings.decimalCharacter) || (n.indexOf(this.settings.decimalCharacter) > 0 || (0 === n.indexOf(this.settings.decimalCharacter) && (n = n.substr(1)), this._setValueParts(i + this.settings.decimalCharacter, n), !0))));
                        if (("-" === this.eventKey || "+" === this.eventKey) && this.settings.isNegativeSignAllowed) return "" === i && d.default.contains(n, "-") ? n = n.replace("-", "") : i = d.default.isNegative(i, "-") ? i.replace("-", "") : "" + this.settings.negativeSignCharacter + i, this._setValueParts(i, n), !0;
                        var a = Number(this.eventKey);
                        return a >= 0 && a <= 9 ? (this.settings.isNegativeSignAllowed && "" === i && d.default.contains(n, "-") && (i = "-", n = n.substring(1, n.length)), this.settings.maximumValue <= 0 && this.settings.minimumValue < this.settings.maximumValue && !d.default.contains(d.default.getElementValue(this.domElement), this.settings.negativeSignCharacter) && "0" !== this.eventKey && (i = "-" + i), this._setValueParts("" + i + this.eventKey, n), !0) : (this.throwInput = !1, !1)
                    }
                }, {
                    key: "_formatValue",
                    value: function (t) {
                        ...
                        h !== i && (this._setElementValue(h, !1), this._setCaretPosition(g)), this.formatted = !0
                    }
                }], [{
                    key: "version",
                    value: function () {
                    ...
                    value: function (t) {
                        var i = void 0;
                        return d.default.isString(t) ? void 0 !== (i = e.getPredefinedOptions()[t]) && null !== i || d.default.warning("The given pre-defined option [" + t + "] is not recognized by autoNumeric. Please check that pre-defined option name.", !0) : i = t, i
                    }
                }, {
                    ...
                    value: function (t) {
                        ...
                        !d.default.isUndefinedOrNullOrEmpty(t) && d.default.isObject(t) || d.default.throwError("The userOptions are invalid ; it should be a valid object, [" + t + "] given.");
                        var a = d.default.isObject(n);
                        a || d.default.isNull(n) || d.default.throwError("The 'originalOptions' parameter is invalid ; it should either be a valid option object or `null`, [" + t + "] given."), d.default.isNull(t) || this._convertOldOptionsToNewOnes(t);
                        var s = void 0;
                        s = i ? o({}, this.getDefaultConfig(), t) : t, d.default.isTrueOrFalseString(s.showWarnings) || d.default.isBoolean(s.showWarnings) || d.default.throwError("The debug option 'showWarnings' is invalid ; it should be either 'false' or 'true', [" + s.showWarnings + "] given.");
                        var u = /^[0-9]+$/,
                            c = /[0-9]+/,
                            h = /^-?[0-9]+(\.?[0-9]+)?$/,
                            m = /^[0-9]+(\.?[0-9]+)?$/;
                        ...
                        (d.default.contains(s.digitGroupSeparator, s.negativeSignCharacter) || d.default.contains(s.decimalCharacter, s.negativeSignCharacter) || d.default.contains(s.decimalCharacterAlternative, s.negativeSignCharacter) || d.default.contains(p, s.negativeSignCharacter) || d.default.contains(y, s.negativeSignCharacter) || d.default.contains(s.suffixText, s.negativeSignCharacter)) && d.default.throwError("The negative sign character option 'negativeSignCharacter' is invalid ; it should not be equal or a part of the digit separator, the decimal character, the decimal character alternative, the negative brackets or the suffix text, [" + s.negativeSignCharacter + "] given."), (d.default.contains(s.digitGroupSeparator, s.positiveSignCharacter) || d.default.contains(s.decimalCharacter, s.positiveSignCharacter) || d.default.contains(s.decimalCharacterAlternative, s.positiveSignCharacter) || d.default.contains(p, s.positiveSignCharacter) || d.default.contains(y, s.positiveSignCharacter) || d.default.contains(s.suffixText, s.positiveSignCharacter)) && d.default.throwError("The positive sign character option 'positiveSignCharacter' is invalid ; it should not be equal or a part of the digit separator, the decimal character, the decimal character alternative, the negative brackets or the suffix text, [" + s.positiveSignCharacter + "] given."), d.default.isNull(s.overrideMinMaxLimits) || d.default.isInArray(s.overrideMinMaxLimits, [e.options.overrideMinMaxLimits.ceiling, e.options.overrideMinMaxLimits.floor, e.options.overrideMinMaxLimits.ignore]) || d.default.throwError("The override min & max limits option 'overrideMinMaxLimits' is invalid ; it should either be 'ceiling', 'floor' or 'ignore', [" + s.overrideMinMaxLimits + "] given."), d.default.isString(s.maximumValue) && h.test(s.maximumValue) || d.default.throwError("The maximum possible value option 'maximumValue' is invalid ; it should be a string that represents a positive or negative number, [" + s.maximumValue + "] given."), d.default.isString(s.minimumValue) && h.test(s.minimumValue) || d.default.throwError("The minimum possible value option 'minimumValue' is invalid ; it should be a string that represents a positive or negative number, [" + s.minimumValue + "] given."), parseFloat(s.minimumValue) > parseFloat(s.maximumValue) && d.default.throwError("The minimum possible value option is greater than the maximum possible value option ; 'minimumValue' [" + s.minimumValue + "] should be smaller than 'maximumValue' [" + s.maximumValue + "]."), d.default.isInt(s.decimalPlaces) && s.decimalPlaces >= 0 || d.default.isString(s.decimalPlaces) && u.test(s.decimalPlaces) || d.default.throwError("The number of decimal places option 'decimalPlaces' is invalid ; it should be a positive integer, [" + s.decimalPlaces + "] given."), d.default.isNull(s.decimalPlacesRawValue) || d.default.isInt(s.decimalPlacesRawValue) && s.decimalPlacesRawValue >= 0 || d.default.isString(s.decimalPlacesRawValue) && u.test(s.decimalPlacesRawValue) || d.default.throwError("The number of decimal places for the raw value option 'decimalPlacesRawValue' is invalid ; it should be a positive integer or `null`, [" + s.decimalPlacesRawValue + "] given."), this._validateDecimalPlacesRawValue(s), d.default.isNull(s.decimalPlacesShownOnFocus) || u.test(String(s.decimalPlacesShownOnFocus)) || d.default.throwError("The number of expanded decimal places option 'decimalPlacesShownOnFocus' is invalid ; it should be a positive integer or `null`, [" + s.decimalPlacesShownOnFocus + "] given."), !d.default.isNull(s.decimalPlacesShownOnFocus) && Number(s.decimalPlaces) > Number(s.decimalPlacesShownOnFocus) && d.default.warning("The extended decimal places 'decimalPlacesShownOnFocus' [" + s.decimalPlacesShownOnFocus + "] should be greater than the 'decimalPlaces' [" + s.decimalPlaces + "] value. Currently, this will limit the ability of your user to manually change some of the decimal places. Do you really want to do that?", s.showWarnings), (d.default.isNull(s.divisorWhenUnfocused) || m.test(s.divisorWhenUnfocused)) && 0 !== s.divisorWhenUnfocused && "0" !== s.divisorWhenUnfocused && 1 !== s.divisorWhenUnfocused && "1" !== s.divisorWhenUnfocused || d.default.throwError("The divisor option 'divisorWhenUnfocused' is invalid ; it should be a positive number higher than one, preferably an integer, [" + s.divisorWhenUnfocused + "] given."), d.default.isNull(s.decimalPlacesShownOnBlur) || u.test(s.decimalPlacesShownOnBlur) || d.default.throwError("The number of decimals shown when unfocused option 'decimalPlacesShownOnBlur' is invalid ; it should be a positive integer or `null`, [" + s.decimalPlacesShownOnBlur + "] given."), d.default.isNull(s.symbolWhenUnfocused) || d.default.isString(s.symbolWhenUnfocused) || d.default.throwError("The symbol to show when unfocused option 'symbolWhenUnfocused' is invalid ; it should be a string, [" + s.symbolWhenUnfocused + "] given."), d.default.isTrueOrFalseString(s.saveValueToSessionStorage) || d.default.isBoolean(s.saveValueToSessionStorage) || d.default.throwError("The save to session storage option 'saveValueToSessionStorage' is invalid ; it should be either 'false' or 'true', [" + s.saveValueToSessionStorage + "] given."), d.default.isInArray(s.onInvalidPaste, [e.options.onInvalidPaste.error, e.options.onInvalidPaste.ignore, e.options.onInvalidPaste.clamp, e.options.onInvalidPaste.truncate, e.options.onInvalidPaste.replace]) || d.default.throwError("The paste behavior option 'onInvalidPaste' is invalid ; it should either be 'error', 'ignore', 'clamp', 'truncate' or 'replace' (cf. documentation), [" + s.onInvalidPaste + "] given."), d.default.isInArray(s.roundingMethod, [e.options.roundingMethod.halfUpSymmetric, e.options.roundingMethod.halfUpAsymmetric, e.options.roundingMethod.halfDownSymmetric, e.options.roundingMethod.halfDownAsymmetric, e.options.roundingMethod.halfEvenBankersRounding, e.options.roundingMethod.upRoundAwayFromZero, e.options.roundingMethod.downRoundTowardZero, e.options.roundingMethod.toCeilingTowardPositiveInfinity, e.options.roundingMethod.toFloorTowardNegativeInfinity, e.options.roundingMethod.toNearest05, e.options.roundingMethod.toNearest05Alt, e.options.roundingMethod.upToNext05, e.options.roundingMethod.downToNext05]) || d.default.throwError("The rounding method option 'roundingMethod' is invalid ; it should either be 'S', 'A', 's', 'a', 'B', 'U', 'D', 'C', 'F', 'N05', 'CHF', 'U05' or 'D05' (cf. documentation), [" + s.roundingMethod + "] given."), d.default.isNull(s.negativeBracketsTypeOnBlur) || d.default.isInArray(s.negativeBracketsTypeOnBlur, [e.options.negativeBracketsTypeOnBlur.parentheses, e.options.negativeBracketsTypeOnBlur.brackets, e.options.negativeBracketsTypeOnBlur.chevrons, e.options.negativeBracketsTypeOnBlur.curlyBraces, e.options.negativeBracketsTypeOnBlur.angleBrackets, e.options.negativeBracketsTypeOnBlur.japaneseQuotationMarks, e.options.negativeBracketsTypeOnBlur.halfBrackets, e.options.negativeBracketsTypeOnBlur.whiteSquareBrackets, e.options.negativeBracketsTypeOnBlur.quotationMarks, e.options.negativeBracketsTypeOnBlur.guillemets]) || d.default.throwError("The brackets for negative values option 'negativeBracketsTypeOnBlur' is invalid ; it should either be '(,)', '[,]', '<,>', '{,}', '〈,〉', '｢,｣', '⸤,⸥', '⟦,⟧', '‹,›' or '«,»', [" + s.negativeBracketsTypeOnBlur + "] given."), d.default.isInArray(s.emptyInputBehavior, [e.options.emptyInputBehavior.focus, e.options.emptyInputBehavior.press, e.options.emptyInputBehavior.always, e.options.emptyInputBehavior.zero, e.options.emptyInputBehavior.null]) || d.default.throwError("The display on empty string option 'emptyInputBehavior' is invalid ; it should either be 'focus', 'press', 'always', 'zero' or 'null', [" + s.emptyInputBehavior + "] given."), s.emptyInputBehavior === e.options.emptyInputBehavior.zero && (s.minimumValue > 0 || s.maximumValue < 0) && d.default.throwError("The 'emptyInputBehavior' option is set to 'zero', but this value is outside of the range defined by 'minimumValue' and 'maximumValue' [" + s.minimumValue + ", " + s.maximumValue + "]."), d.default.isTrueOrFalseString(s.eventBubbles) || d.default.isBoolean(s.eventBubbles) || d.default.throwError("The event bubbles option 'eventBubbles' is invalid ; it should be either 'true' or 'false', [" + s.eventBubbles + "] given."), d.default.isTrueOrFalseString(s.eventIsCancelable) || d.default.isBoolean(s.eventIsCancelable) || d.default.throwError("The event is cancelable option 'eventIsCancelable' is invalid ; it should be either 'true' or 'false', [" + s.eventIsCancelable + "] given."), d.default.isInArray(s.leadingZero, [e.options.leadingZero.allow, e.options.leadingZero.deny, e.options.leadingZero.keep]) || d.default.throwError("The leading zero behavior option 'leadingZero' is invalid ; it should either be 'allow', 'deny' or 'keep', [" + s.leadingZero + "] given."), d.default.isTrueOrFalseString(s.formatOnPageLoad) || d.default.isBoolean(s.formatOnPageLoad) || d.default.throwError("The format on initialization option 'formatOnPageLoad' is invalid ; it should be either 'false' or 'true', [" + s.formatOnPageLoad + "] given."), u.test(s.historySize) && 0 !== s.historySize || d.default.throwError("The history size option 'historySize' is invalid ; it should be a positive integer, [" + s.historySize + "] given."), d.default.isTrueOrFalseString(s.selectNumberOnly) || d.default.isBoolean(s.selectNumberOnly) || d.default.throwError("The select number only option 'selectNumberOnly' is invalid ; it should be either 'false' or 'true', [" + s.selectNumberOnly + "] given."), d.default.isTrueOrFalseString(s.selectOnFocus) || d.default.isBoolean(s.selectOnFocus) || d.default.throwError("The select on focus option 'selectOnFocus' is invalid ; it should be either 'false' or 'true', [" + s.selectOnFocus + "] given."), d.default.isNull(s.defaultValueOverride) || "" === s.defaultValueOverride || h.test(s.defaultValueOverride) || d.default.throwError("The unformatted default value option 'defaultValueOverride' is invalid ; it should be a string that represents a positive or negative number, [" + s.defaultValueOverride + "] given."), d.default.isTrueOrFalseString(s.unformatOnSubmit) || d.default.isBoolean(s.unformatOnSubmit) || d.default.throwError("The remove formatting on submit option 'unformatOnSubmit' is invalid ; it should be either 'false' or 'true', [" + s.unformatOnSubmit + "] given."), d.default.isNull(s.valuesToStrings) || d.default.isObject(s.valuesToStrings) || d.default.throwError("The option 'valuesToStrings' is invalid ; it should be an object, ideally with 'key -> value' entries, [" + s.valuesToStrings + "] given."), d.default.isNull(s.outputFormat) || d.default.isInArray(s.outputFormat, [e.options.outputFormat.string, e.options.outputFormat.number, e.options.outputFormat.dot, e.options.outputFormat.negativeDot, e.options.outputFormat.comma, e.options.outputFormat.negativeComma, e.options.outputFormat.dotNegative, e.options.outputFormat.commaNegative]) || d.default.throwError("The custom locale format option 'outputFormat' is invalid ; it should either be null, 'string', 'number', '.', '-.', ',', '-,', '.-' or ',-', [" + s.outputFormat + "] given."), d.default.isTrueOrFalseString(s.isCancellable) || d.default.isBoolean(s.isCancellable) || d.default.throwError("The cancellable behavior option 'isCancellable' is invalid ; it should be either 'false' or 'true', [" + s.isCancellable + "] given."), d.default.isTrueOrFalseString(s.modifyValueOnWheel) || d.default.isBoolean(s.modifyValueOnWheel) || d.default.throwError("The increment/decrement on mouse wheel option 'modifyValueOnWheel' is invalid ; it should be either 'false' or 'true', [" + s.modifyValueOnWheel + "] given."), d.default.isTrueOrFalseString(s.watchExternalChanges) || d.default.isBoolean(s.watchExternalChanges) || d.default.throwError("The option 'watchExternalChanges' is invalid ; it should be either 'false' or 'true', [" + s.watchExternalChanges + "] given."), d.default.isInArray(s.wheelOn, [e.options.wheelOn.focus, e.options.wheelOn.hover]) || d.default.throwError("The wheel behavior option 'wheelOn' is invalid ; it should either be 'focus' or 'hover', [" + s.wheelOn + "] given."), (!d.default.isString(s.wheelStep) && !d.default.isNumber(s.wheelStep) || "progressive" !== s.wheelStep && !m.test(s.wheelStep) || 0 === Number(s.wheelStep)) && d.default.throwError("The wheel step value option 'wheelStep' is invalid ; it should either be the string 'progressive', or a number or a string that represents a positive number (excluding zero), [" + s.wheelStep + "] given."), d.default.isInArray(s.serializeSpaces, [e.options.serializeSpaces.plus, e.options.serializeSpaces.percent]) || d.default.throwError("The space replacement character option 'serializeSpaces' is invalid ; it should either be '+' or '%20', [" + s.serializeSpaces + "] given."), d.default.isTrueOrFalseString(s.noEventListeners) || d.default.isBoolean(s.noEventListeners) || d.default.throwError("The option 'noEventListeners' that prevent the creation of event listeners is invalid ; it should be either 'false' or 'true', [" + s.noEventListeners + "] given."), d.default.isNull(s.styleRules) || d.default.isObject(s.styleRules) && (s.styleRules.hasOwnProperty("positive") || s.styleRules.hasOwnProperty("negative") || s.styleRules.hasOwnProperty("ranges") || s.styleRules.hasOwnProperty("userDefined")) || d.default.throwError("The option 'styleRules' is invalid ; it should be a correctly structured object, with one or more 'positive', 'negative', 'ranges' or 'userDefined' attributes, [" + s.styleRules + "] given."), d.default.isNull(s.styleRules) || !s.styleRules.hasOwnProperty("userDefined") || d.default.isNull(s.styleRules.userDefined) || s.styleRules.userDefined.forEach(function (e) {
                            e.hasOwnProperty("callback") && !d.default.isFunction(e.callback) && d.default.throwError("The callback defined in the `userDefined` attribute is not a function, " + l(e.callback) + " given.")
                        }), (d.default.isNull(s.rawValueDivisor) || m.test(s.rawValueDivisor)) && 0 !== s.rawValueDivisor && "0" !== s.rawValueDivisor && 1 !== s.rawValueDivisor && "1" !== s.rawValueDivisor || d.default.throwError("The raw value divisor option 'rawValueDivisor' is invalid ; it should be a positive number higher than one, preferably an integer, [" + s.rawValueDivisor + "] given."), d.default.isTrueOrFalseString(s.readOnly) || d.default.isBoolean(s.readOnly) || d.default.throwError("The option 'readOnly' is invalid ; it should be either 'false' or 'true', [" + s.readOnly + "] given."), d.default.isTrueOrFalseString(s.unformatOnHover) || d.default.isBoolean(s.unformatOnHover) || d.default.throwError("The option 'unformatOnHover' is invalid ; it should be either 'false' or 'true', [" + s.unformatOnHover + "] given."), d.default.isTrueOrFalseString(s.failOnUnknownOption) || d.default.isBoolean(s.failOnUnknownOption) || d.default.throwError("The debug option 'failOnUnknownOption' is invalid ; it should be either 'false' or 'true', [" + s.failOnUnknownOption + "] given."), d.default.isTrueOrFalseString(s.createLocalList) || d.default.isBoolean(s.createLocalList) || d.default.throwError("The debug option 'createLocalList' is invalid ; it should be either 'false' or 'true', [" + s.createLocalList + "] given.")
                    }
                }, {
                    key: "_validateDecimalPlacesRawValue",
                    value: function (e) {
                        d.default.isNull(e.decimalPlacesRawValue) || (e.decimalPlacesRawValue < e.decimalPlaces && d.default.warning("The number of decimal places to store in the raw value [" + e.decimalPlacesRawValue + "] is lower than the ones to display [" + e.decimalPlaces + "]. This will likely confuse your users.\nTo solve that, you'd need to either set `decimalPlacesRawValue` to `null`, or set a number of decimal places for the raw value equal of bigger than `decimalPlaces`.", e.showWarnings), e.decimalPlacesRawValue < e.decimalPlacesShownOnFocus && d.default.warning("The number of decimal places to store in the raw value [" + e.decimalPlacesRawValue + "] is lower than the ones shown on focus [" + e.decimalPlacesShownOnFocus + "]. This will likely confuse your users.\nTo solve that, you'd need to either set `decimalPlacesRawValue` to `null`, or set a number of decimal places for the raw value equal of bigger than `decimalPlacesShownOnFocus`.", e.showWarnings), e.decimalPlacesRawValue < e.decimalPlacesShownOnBlur && d.default.warning("The number of decimal places to store in the raw value [" + e.decimalPlacesRawValue + "] is lower than the ones shown when unfocused [" + e.decimalPlacesShownOnBlur + "]. This will likely confuse your users.\nTo solve that, you'd need to either set `decimalPlacesRawValue` to `null`, or set a number of decimal places for the raw value equal of bigger than `decimalPlacesShownOnBlur`.", e.showWarnings))
                    }
                }, {
                    ...
                    value: function (e) {
                        var t = this,
                            i = void 0;
                        return d.default.isUndefinedOrNullOrEmpty(e) || 0 === e.length ? i = null : (i = {}, 1 === e.length && Array.isArray(e[0]) ? e[0].forEach(function (e) {
                            o(i, t._getOptionObject(e))
                    ...
                    value: function (t) {
                        ...
                        var i = void 0;
                        i = d.default.isElement(t) ? d.default.getElementValue(t) : t, d.default.isString(i) || d.default.isNumber(i) || d.default.throwError('The value "' + i + '" being "set" is not numeric and therefore cannot be used appropriately.');
                        ...
                        u.isNegativeSignAllowed = i < 0, u.isPositiveSignAllowed = i >= 0;
                        var c = {};
                        this._cachesUsualRegularExpressions(u, c);
                        var h = this._toNumericValue(i, u);
                        isNaN(Number(h)) && d.default.throwError("The value [" + h + "] that you are trying to format is not a recognized number.");
                        var m = this._checkIfInRangeWithOverrideOption(h, u),
                            g = r(m, 2),
                            f = g[0],
                            v = g[1];
                        return f && v || (this._triggerEvent(e.events.formatted, document, {
                            oldValue: null,
                            newValue: null,
                            oldRawValue: null,
                            newRawValue: null,
                    ...
                    value: function (e) {
                        ...
                        if (l.isNegativeSignAllowed = !1, l.isPositiveSignAllowed = !0, t = t.toString(), l.valuesToStrings && this._checkStringsToValuesSettings(t, l)) return d.default.objectKeyLookup(l.valuesToStrings, t);
                        if (d.default.isNegative(t, l.negativeSignCharacter)) l.isNegativeSignAllowed = !0, l.isPositiveSignAllowed = !1;
                        else if (!d.default.isNull(l.negativeBracketsTypeOnBlur)) {
                            var u = l.negativeBracketsTypeOnBlur.split(","),
                                c = r(u, 2);
                            l.firstBracket = c[0], l.lastBracket = c[1], t.charAt(0) === l.firstBracket && t.charAt(t.length - 1) === l.lastBracket && (l.isNegativeSignAllowed = !0, l.isPositiveSignAllowed = !1, t = this._removeBrackets(t, l, !1))
                        }
                        return t = this._convertToNumericString(t, l), new RegExp("[^+-0123456789.]", "gi").test(t) ? NaN : (this._correctNegativePositiveSignPlacementOption(l), l.decimalPlacesRawValue ? l.originalDecimalPlacesRawValue = l.decimalPlacesRawValue : l.originalDecimalPlacesRawValue = l.decimalPlaces, this._calculateDecimalPlacesOnInit(l), d.default.isUndefinedOrNullOrEmpty(l.rawValueDivisor) || 0 === l.rawValueDivisor || "" === t || null === t || (t /= l.rawValueDivisor), t = this._roundRawValue(t, l), t = t.replace(l.decimalCharacter, "."), t = this._toLocale(t, l.outputFormat, l))
                    }
                }, {
                    key: "unformatAndSet",
                    value: function (e) {
                    ...
                    value: function (t) {
                        var i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
                            n = void 0;
                        if ("" === (n = d.default.isElement(t) ? d.default.getElementValue(t) : t)) return "";
                        d.default.isNull(i) && (i = e.defaultSettings), n = this.unformat(n, i), 0 === Number(n) && i.leadingZero !== e.options.leadingZero.keep && (n = "0");
                        var a = void 0;
                        return a = d.default.isNull(i) ? i.outputFormat : e.defaultSettings.outputFormat, this._toLocale(n, a, i)
                    }
                }, {
                    key: "localizeAndSet",
                    value: function (e) {
                    ...
                    value: function (e, t) {
                        ...
                        if (!this.isManagedByAutoNumeric(a)) {
                            var s = void 0;
                            return s = !(!d.default.isNull(i) && i.hasOwnProperty("showWarnings")) || i.showWarnings, d.default.warning("Impossible to find an AutoNumeric object for the given DOM element or selector.", s), null
                        }
                    ...
                    value: function (t, i, n, a) {
                        t = this._normalizeCurrencySuffixAndNegativeSignCharacters(t, i), t = t.replace(i.allowedAutoStrip, "");
                        ...
                        if (t = s ? [s[1], s[2], s[3]].join("") : "", i.leadingZero === e.options.leadingZero.allow || i.leadingZero === e.options.leadingZero.keep) {
                            var o = "",
                                ...
                                h = u[1],
                                m = c;
                            d.default.contains(m, i.negativeSignCharacter) && (o = i.negativeSignCharacter, m = m.replace(i.negativeSignCharacter, "")), "" === o && m.length > i.mIntPos && "0" === m.charAt(0) && (m = m.slice(1)), "" !== o && m.length > i.mIntNeg && "0" === m.charAt(0) && (m = m.slice(1)), t = "" + o + m + (d.default.isUndefined(h) ? "" : i.decimalCharacter + h)
                        }
                    ...
                    value: function (e, t) {
                        var i = !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2],
                            n = void 0;
                        return d.default.isNull(t.negativeBracketsTypeOnBlur) || e.charAt(0) !== t.firstBracket ? n = e : (n = e.replace(t.firstBracket, ""), n = n.replace(t.lastBracket, ""), i ? (n = n.replace(t.currencySymbol, ""), n = this._mergeCurrencySignNegativePositiveSignAndValue(n, t, !0, !1)) : n = "" + t.negativeSignCharacter + n), n
                    }
                }, {
                    key: "_convertToNumericString",
                    value: function (t, i) {
                        t = this._removeBrackets(t, i, !1), t = this._normalizeCurrencySuffixAndNegativeSignCharacters(t, i), t = t.replace(new RegExp("[" + i.digitGroupSeparator + "]", "g"), ""), "." !== i.decimalCharacter && (t = t.replace(i.decimalCharacter, ".")), d.default.isNegative(t) && t.lastIndexOf("-") === t.length - 1 && (t = t.replace("-", ""), t = "-" + t), i.showPositiveSign && (t = t.replace(i.positiveSignCharacter, ""));
                    ...
                    value: function (t, i) {
                        return t = String(t), i.currencySymbol !== e.options.currencySymbol.none && (t = t.replace(i.currencySymbol, "")), i.suffixText !== e.options.suffixText.none && (t = t.replace(i.suffixText, "")), i.negativeSignCharacter !== e.options.negativeSignCharacter.hyphen && (t = t.replace(i.negativeSignCharacter, "-")), t
                    }
                }, {
                    key: "_toLocale",
                    value: function (t, i, n) {
                        if (d.default.isNull(i) || i === e.options.outputFormat.string) return t;
                        var a = void 0;
                        switch (i) {
                            ...
                            case e.options.outputFormat.dotNegative:
                                a = d.default.isNegative(t) ? t.replace("-", "") + "-" : t;
                                break;
                            ...
                            case e.options.outputFormat.commaNegative:
                                a = t.replace(".", ","), a = d.default.isNegative(a) ? a.replace("-", "") + "-" : a;
                                break;
                            ...
                            case e.options.outputFormat.negativeDot:
                                ...
                                break;
                            default:
                                d.default.throwError("The given outputFormat [" + i + "] option is not recognized.")
                        }
                        return i !== e.options.outputFormat.number && "-" !== n.negativeSignCharacter && (a = a.replace("-", n.negativeSignCharacter)), a
                    }
                }, {
                    ...
                    value: function (t, i, n) {
                        return i.emptyInputBehavior === e.options.emptyInputBehavior.always || n ? i.negativePositiveSignPlacement === e.options.negativePositiveSignPlacement.left ? t + i.currencySymbol + i.suffixText : i.currencySymbol + t + i.suffixText : t
                    }
                }, {
                    ...
                    value: function (t, i, n, a) {
                        ...
                        var c = t.split(i.decimalCharacter),
                            ...
                            m = h[0],
                            g = h[1];
                        if (i.decimalCharacterAlternative && d.default.isUndefined(g)) {
                        ...
                        var p = void 0;
                        p = n ? i.decimalPlacesShownOnFocus : i.decimalPlacesShownOnBlur, 0 === p || d.default.isUndefined(g) ? t = m : (g.length > p && (g = g.substring(0, p)), t = "" + m + i.decimalCharacter + g), t = e._mergeCurrencySignNegativePositiveSignAndValue(t, i, o, l), d.default.isNull(s) && (s = a), null !== i.negativeBracketsTypeOnBlur && (s < 0 || d.default.isNegativeStrict(t, i.negativeSignCharacter)) && (t = this._toggleNegativeBracket(t, i, n));
                    ...
                    value: function (t, i, n) {
                        ...
                        var l = t.lastIndexOf("."),
                            u = -1 === l,
                            c = t.split(".");
                        if (!(r(c, 2)[1] > 0 || i.allowDecimalPadding !== e.options.allowDecimalPadding.never && i.allowDecimalPadding !== e.options.allowDecimalPadding.floats)) return 0 === Number(t) ? t : "" + o + t;
                        var h = void 0;
                        h = i.allowDecimalPadding === e.options.allowDecimalPadding.always || i.allowDecimalPadding === e.options.allowDecimalPadding.floats ? n : 0;
                        ...
                        if (g <= n) {
                            if (f = t, g < h) {
                                ...
                                for (var v = "000000"; g < h;) v = v.substring(0, h - g), f += v, g += v.length
                            } else g > h ? f = this._truncateZeros(f, h) : 0 === g && 0 === h && (f = f.replace(/\.$/, ""));
                        ...
                        var y = Number(t.charAt(p + 1)),
                            ...
                            b = void 0;
                        if (b = "." === t.charAt(p) ? t.charAt(p - 1) % 2 : t.charAt(p) % 2, this._shouldRoundUp(y, i, o, b))
                            for (var P = S.length - 1; P >= 0; P -= 1)
                                if ("." !== S[P]) {
                                    if (S[P] = +S[P] + 1, S[P] < 10) break;
                                    P > 0 && (S[P] = "0")
                                } return S = S.slice(0, p + 1), f = this._truncateZeros(S.join(""), h), 0 === Number(f) ? f : "" + o + f
                    }
                }, {
                    key: "_roundCloseTo05",
                    value: function (t, i) {
                        ...
                        return d.default.contains(t, ".") ? t.length - t.indexOf(".") < 3 ? t + "0" : t : t + ".00"
                    }
                }, {
                    key: "_prepareValueForRounding",
                    value: function (t, i) {
                        var n = "";
                        return d.default.isNegativeStrict(t, "-") && (n = "-", t = t.replace("-", "")), t.match(/^\d/) || (t = "0" + t), 0 === Number(t) && (n = ""), (Number(t) > 0 && i.leadingZero !== e.options.leadingZero.keep || t.length > 0 && i.leadingZero === e.options.leadingZero.allow) && (t = t.replace(/^0*(\d)/, "$1")), [n, t]
                    }
                }, {
                    key: "_shouldRoundUp",
                    value: function (t, i, n, a) {
                    ...
                    value: function (t, i) {
                        if (d.default.isNull(t) && i.emptyInputBehavior === e.options.emptyInputBehavior.null) return [!0, !0];
                        ...
                        switch (i.overrideMinMaxLimits) {
                            ...
                            case e.options.overrideMinMaxLimits.ignore:
                                ...
                                break;
                            default:
                                r = [d.default.testMinMax(n, s) > -1, d.default.testMinMax(a, s) < 1]
                        }
                        return r
                    }
                }, {
                    ...
                    value: function (t) {
                        return d.default.isNull(t) ? null : (!d.default.isUndefinedOrNullOrEmpty(t.caretPositionOnFocus) && d.default.isUndefinedOrNullOrEmpty(t.selectOnFocus) && (t.selectOnFocus = e.options.selectOnFocus.doNotSelect), d.default.isUndefinedOrNullOrEmpty(t.caretPositionOnFocus) && !d.default.isUndefinedOrNullOrEmpty(t.selectOnFocus) && t.selectOnFocus === e.options.selectOnFocus.select && (t.caretPositionOnFocus = e.options.caretPositionOnFocus.doNoForceCaretPosition), t)
                    }
                }, {
                    ...
                    value: function (t) {
                        ...
                        var i = 0;
                        t.rawValueDivisor && t.rawValueDivisor !== e.options.rawValueDivisor.none && (i = String(t.rawValueDivisor).length - 1) < 0 && (i = 0), t.decimalPlacesRawValue = Math.max(Math.max(t.decimalPlacesShownOnBlur, t.decimalPlacesShownOnFocus) + i, Number(t.originalDecimalPlacesRawValue) + i)
                    }
                }, {
                    key: "_calculateDecimalPlacesOnUpdate",
                    value: function (t) {
                        var i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null;
                        this._validateDecimalPlacesRawValue(t), d.default.isNull(i) && d.default.throwError("When updating the settings, the previous ones should be passed as an argument.");
                    ...
                    value: function (t, i) {
                        var n = void 0;
                        n = t.negativeSignCharacter !== e.options.negativeSignCharacter.hyphen ? "([-\\" + t.negativeSignCharacter + "]?)" : "(-?)", i.aNegRegAutoStrip = n, t.allowedAutoStrip = new RegExp("[^-0123456789\\" + t.decimalCharacter + "]", "g"), t.numRegAutoStrip = new RegExp(n + "(?:\\" + t.decimalCharacter + "?([0-9]+\\" + t.decimalCharacter + "[0-9]+)|([0-9]*(?:\\" + t.decimalCharacter + "[0-9]*)?))"), t.stripReg = new RegExp("^" + i.aNegRegAutoStrip + "0*([0-9])")
                    }
                }, {
                    ...
                    value: function (e) {
                        ...
                        "mDec" in e && d.default.warning("The old `mDec` option has been deprecated in favor of more accurate options ; `decimalPlaces`, `decimalPlacesRawValue`, `decimalPlacesShownOnFocus` and `decimalPlacesShownOnBlur`.", !0)
                    }
                }, {
                    ...
                    value: function (e, t) {
                        var i = void 0;
                        return d.default.isNumber(Number(e)) ? i = e : (i = this._convertToNumericString(e.toString(), t), d.default.isNumber(Number(i)) || (d.default.warning('The given value "' + e + '" cannot be converted to a numeric one and therefore cannot be used appropriately.', t.showWarnings), i = NaN)), i
                    }
                }, {
                    key: "_checkIfInRange",
                    value: function (e, t, i) {
                        var n = d.default.parseStr(e);
                        return d.default.testMinMax(t, n) > -1 && d.default.testMinMax(i, n) < 1
                    }
                }, {
                    key: "_shouldSkipEventKey",
                    value: function (e) {
                        var t = d.default.isInArray(e, m.default.keyName._allFnKeys),
                    ...
                    value: function (e) {
                        var t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                            ...
                            r = [];
                        "object" === (void 0 === e ? "undefined" : l(e)) && "form" === e.nodeName.toLowerCase() && Array.prototype.slice.call(e.elements).forEach(function (e) {
                            if (e.name && !e.disabled && -1 === ["file", "reset", "submit", "button"].indexOf(e.type))
                                ...
                                if (n.isManagedByAutoNumeric(e)) {
                                    ...
                                    switch (i) {
                                        case "unformatted":
                                            o = n.getAutoNumericElement(e), d.default.isNull(o) || (a = n.unformat(e, o.getSettings()));
                                            break;
                                        case "localized":
                                            if (o = n.getAutoNumericElement(e), !d.default.isNull(o)) {
                                                var l = d.default.cloneObject(o.getSettings());
                                                d.default.isNull(s) || (l.outputFormat = s), a = n.localize(e, l)
                                            }
                                            break;
                                        case "formatted":
                                        default:
                                ...
                                d.default.isUndefined(a) && d.default.throwError("This error should never be hit. If it has, something really wrong happened!"), t ? r.push({
                                    name: e.name,
                                    value: a
                        ...
                        var o = void 0;
                        return t ? o = r : (o = r.join("&"), "+" === a && (o = o.replace(/%20/g, "+"))), o
                    }
                }, {
        ...
        t.default = g, g.multiple = function (e) {
                var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null,
                    i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null,
                    n = [];
                if (d.default.isObject(t) && (i = t, t = null), d.default.isString(e)) e = [].concat(a(document.querySelectorAll(e)));
                    ...
                    e.hasOwnProperty("exclude") ? (Array.isArray(e.exclude) || d.default.throwError("The 'exclude' array passed to the 'multiple' function is invalid."), e = d.default.filterOut(s, e.exclude)) : e = s
                } else d.default.isArray(e) || d.default.throwError("The given parameters to the 'multiple' function are invalid.");
                if (0 === e.length) {
                    var r = !0;
                    return !d.default.isNull(i) && d.default.isBoolean(i.showWarnings) && (r = i.showWarnings), d.default.warning("No valid DOM elements were given hence no AutoNumeric object were instantiated.", r), []
                }
                ...
                if (u) {
                    var m = l(Number(t[0]));
                    c = "number" === m && !isNaN(Number(t[0])), c || ("string" === m || isNaN(m) || "object" === m) && (h = !0)
                }
                ...
                var S = d.default.isNumber(t),
                    b = void 0;
                return c && (b = t.length), e.forEach(function (e, i) {
                    S ? n.push(new g(e, t, y)) : c && i <= b ? n.push(new g(e, t[i], y)) : n.push(new g(e, null, y))
                }), n
            },
            function () {
                function e(e, t) {
                ...
                if ("undefined" == typeof window || "function" === window.CustomEvent) return !1;
                e.prototype = window.Event.prototype, window.CustomEvent = e, Array.from || (Array.from = function (e) {
                    return [].slice.call(e)
                })
            }(), e.exports = t.default
    }, function (e, t, i) {
        ...
        var s = Object.assign || function (e) {
            ...
            d = function () {
                ...
                return l(e, null, [{
                    ...
                    key: "isObject",
                    value: function (e) {
                        return "object" === (void 0 === e ? "undefined" : o(e)) && null !== e && !Array.isArray(e)
                    }
                }, {
                    key: "isEmptyObj",
                    value: function (e) {
                    ...
                    key: "isArray",
                    value: function (e) {
                        if ("[object Array]" === Object.prototype.toString.call([])) return Array.isArray(e) || "object" === (void 0 === e ? "undefined" : o(e)) && "[object Array]" === Object.prototype.toString.call(e);
                        ...
                        if ("Unidentified" === t.key || void 0 === t.key || this.isSeleniumBot()) {
                            ...
                            switch (t.key) {
                                ...
                                case "Decimal":
                                    ...
                                    break;
                                case "Del":
                                    s = this.browser(), i = "firefox" === s.name && s.version <= 36 || "ie" === s.name && s.version <= 9 ? c.default.keyName.Dot : c.default.keyName.Delete;
                                    break;
                                case "Divide":
                    ...
                    key: "warning",
                    value: function (e) {
                        (!(arguments.length > 1 && void 0 !== arguments[1]) || arguments[1]) && console.warn("Warning: " + e)
                    }
                }, {
                    key: "isWheelUpEvent",
                    value: function (e) {
                    ...
                    value: function (e) {
                        ...
                        window.CustomEvent ? s = new CustomEvent(e, {
                            ...
                            bubbles: n,
                            cancelable: a
                        }) : (s = document.createEvent("CustomEvent"), s.initCustomEvent(e, n, a, {
                            detail: i
                        })), t.dispatchEvent(s)
                    }
                }, {
                    ...
                    value: function (e) {
                        var t = {},
                            ...
                            a = void 0,
                            s = void 0;
                        if (0 === e && 1 / e < 0 && (e = "-0"), e = e.toString(), this.isNegativeStrict(e, "-") ? (e = e.slice(1), t.s = -1) : t.s = 1, i = e.indexOf("."), i > -1 && (e = e.replace(".", "")), i < 0 && (i = e.length), n = -1 === e.search(/[1-9]/i) ? e.length : e.search(/[1-9]/i), a = e.length, n === a) t.e = 0, t.c = [0];
                        else {
                            for (s = a - 1;
        ...
        Object.defineProperty(s.default, "defaultSettings", {
            get: function () {
                return {
                    ...
                    caretPositionOnFocus: s.default.options.caretPositionOnFocus.doNoForceCaretPosition,
                    createLocalList: s.default.options.createLocalList.createList,
                    currencySymbol: s.default.options.currencySymbol.none,
                    currencySymbolPlacement: s.default.options.currencySymbolPlacement.prefix,
                    decimalCharacter: s.default.options.decimalCharacter.dot,
                    decimalCharacterAlternative: s.default.options.decimalCharacterAlternative.none,
                    decimalPlaces: s.default.options.decimalPlaces.two,
                    decimalPlacesRawValue: s.default.options.decimalPlacesRawValue.useDefault,
                    decimalPlacesShownOnBlur: s.default.options.decimalPlacesShownOnBlur.useDefault,
                    decimalPlacesShownOnFocus: s.default.options.decimalPlacesShownOnFocus.useDefault,
                    defaultValueOverride: s.default.options.defaultValueOverride.doNotOverride,
                    ...
                    modifyValueOnWheel: s.default.options.modifyValueOnWheel.modifyValue,
                    negativeBracketsTypeOnBlur: s.default.options.negativeBracketsTypeOnBlur.none,
                    negativePositiveSignPlacement: s.default.options.negativePositiveSignPlacement.none,
                    negativeSignCharacter: s.default.options.negativeSignCharacter.hyphen,
                    ...
                    overrideMinMaxLimits: s.default.options.overrideMinMaxLimits.doNotOverride,
                    ...
                    saveValueToSessionStorage: s.default.options.saveValueToSessionStorage.doNotSave,
                    selectNumberOnly: s.default.options.selectNumberOnly.selectNumbersOnly,
                    selectOnFocus: s.default.options.selectOnFocus.select,
                    serializeSpaces: s.default.options.serializeSpaces.plus,
                    showOnlyNumbersOnFocus: s.default.options.showOnlyNumbersOnFocus.showAll,
                    ...
                    unformatOnSubmit: s.default.options.unformatOnSubmit.keepCurrentValue,
                    valuesToStrings: s.default.options.valuesToStrings.none,
                    watchExternalChanges: s.default.options.watchExternalChanges.doNotWatch,
        ...
        var a = i(0),
            ...
            l = {
                ...
                decimalCharacterAlternative: s.default.options.decimalCharacterAlternative.dot,
                currencySymbol: " €",
                currencySymbolPlacement: s.default.options.currencySymbolPlacement.suffix,
                negativePositiveSignPlacement: s.default.options.negativePositiveSignPlacement.prefix
            },
            u = {
                digitGroupSeparator: s.default.options.digitGroupSeparator.comma,
                decimalCharacter: s.default.options.decimalCharacter.dot,
                ...
                currencySymbolPlacement: s.default.options.currencySymbolPlacement.prefix,
                negativePositiveSignPlacement: s.default.options.negativePositiveSignPlacement.right
            },
            c = {
                digitGroupSeparator: s.default.options.digitGroupSeparator.comma,
                decimalCharacter: s.default.options.decimalCharacter.dot,
        ...
        h.maximumValue = 0, h.negativePositiveSignPlacement = s.default.options.negativePositiveSignPlacement.prefix;
        ...
        f.maximumValue = 0, f.negativePositiveSignPlacement = s.default.options.negativePositiveSignPlacement.prefix;
        var v = o.default.cloneObject(l);
        v.currencySymbol = s.default.options.currencySymbol.none, v.suffixText = " " + s.default.options.suffixText.percentage, v.wheelStep = 1e-4, v.rawValueDivisor = s.default.options.rawValueDivisor.percentage;
        var p = o.default.cloneObject(v);
        p.minimumValue = 0;
        var y = o.default.cloneObject(v);
        y.maximumValue = 0, y.negativePositiveSignPlacement = s.default.options.negativePositiveSignPlacement.prefix;
        ...
        O.maximumValue = 0, O.negativePositiveSignPlacement = s.default.options.negativePositiveSignPlacement.prefix;
        var N = o.default.cloneObject(O);
        N.negativeBracketsTypeOnBlur = s.default.options.negativeBracketsTypeOnBlur.parentheses;
        var E = o.default.cloneObject(u);
        E.currencySymbol = s.default.options.currencySymbol.none, E.suffixText = s.default.options.suffixText.percentage, E.wheelStep = 1e-4, v.rawValueDivisor = s.default.options.rawValueDivisor.percentage;
        var k = o.default.cloneObject(E);
        k.minimumValue = 0;
        var _ = o.default.cloneObject(E);
        _.maximumValue = 0, _.negativePositiveSignPlacement = s.default.options.negativePositiveSignPlacement.prefix;
        var C = o.default.cloneObject(E);
        C.decimalPlaces = 3;
        var F = o.default.cloneObject(k);
        F.decimalPlaces = 3;
        var V = o.default.cloneObject(_);
        V.decimalPlaces = 3, Object.defineProperty(s.default, "predefinedOptions", {
            get: function () {
                return {
                    euro: l,
                    euroPos: d,
                    ...
                    Swiss: {
                        digitGroupSeparator: s.default.options.digitGroupSeparator.apostrophe,
                        decimalCharacter: s.default.options.decimalCharacter.dot,
                        currencySymbol: " CHF",
                        currencySymbolPlacement: s.default.options.currencySymbolPlacement.suffix,
                        negativePositiveSignPlacement: s.default.options.negativePositiveSignPlacement.prefix
                    ...
                    float: {
                        allowDecimalPadding: s.default.options.allowDecimalPadding.never
                    },
                    floatPos: {
                        allowDecimalPadding: s.default.options.allowDecimalPadding.never,
                        minimumValue: s.default.options.minimumValue.zero,
                    ...
                    numeric: {
                        digitGroupSeparator: s.default.options.digitGroupSeparator.noSeparator,
                        decimalCharacter: s.default.options.decimalCharacter.dot,
                        currencySymbol: s.default.options.currencySymbol.none
                    },
                    numericPos: {
